...
class MixedPoolLayer(nn.Module):
    ...
    def __init__(self, n=4, mix_ratio=0.5):
        """
        MixedPoolLayer
        mix_ratio (float): The mixing ratio of maximum and average pooling results ranges from 0 to 1,
        where 0 is full average pooling and 1 is full maximum pooling
        """
        super().__init__()
        self.n = n
